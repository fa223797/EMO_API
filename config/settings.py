"""
Django 设置文件 - config 项目
由 'django-admin startproject' 使用 Django 5.1.6 自动生成
更多信息请参考：
...
# 安全警告：请勿在生产环境中泄露密钥！
SECRET_KEY = 'django-insecure-+c8^4h8l%w)tw##stki5sqbr*^8x*b0-klk8xdl#fqd&+im7r-'
...
AUTH_USER_MODEL = 'ai_app.CustomUser'  # 自定义用户模型
...
CONSTANCE_CONFIG = {
    ...
    'GLM_API_KEY': ('98fd7efde5b04a9ab8ded261b0cd54e5.iSTkJXlCzxR1rMC9', 'GLM API密钥'),
    'COZE_API_TOKEN': ('pat_g29XD40XKp9DFbztQUVFzbbarqPceZ7jhIOGDkqeEHpcMYhL753COSdIF4xMLt6P', 'COZE API令牌'),
    'COZE_BOT_ID': ('7471264796252487689', 'COZE 机器人ID'),
    'QWEN_API_KEY': ('sk-e820da316ff34addb3c12d4be1461e96', 'Qwen API密钥'),
...
CONSTANCE_CONFIG_FIELDSETS = {
    ...
    'API密钥配置': ['GLM_API_KEY', 'COZE_API_TOKEN', 'COZE_BOT_ID', 'QWEN_API_KEY'],
    '微信配置': ['WECHAT_APP_ID'],
}
